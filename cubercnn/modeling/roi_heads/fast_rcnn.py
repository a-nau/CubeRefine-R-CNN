...
def fast_rcnn_inference_single_image(
    ...
    boxes, scores, filter_inds, scores_full = (
        boxes[keep],
        scores[keep],
        filter_inds[keep],
        scores_full[keep],
...
class FastRCNNOutputs(FastRCNNOutputLayers):
    ...
    def losses(self, predictions, proposals):
        ...
        loss_box_reg = self.box_reg_loss(
            proposal_boxes, gt_boxes, proposal_deltas, gt_classes, reduction="none"
        )
    ...
    def box_reg_loss(
        self, proposal_boxes, gt_boxes, pred_deltas, gt_classes, reduction="mean"
    ):
        """
        Args:
